...
toggle.addEventListener('click', function(){
    ...
    if(this.classList.toggle('bi-brightness-high-fill')){
        ...
        <form action="" method="POST">
         <input type="number" name="cin_p" id="cin_p" placeholder="ID Card" required/>
         <input type="text" name="nom_prenom_p" id="nom_prenom_p" placeholder="Fullname"  required />
         <input type="text" name="email_p" id="email_p" placeholder="Email address"  required />
         <input type="date" name="date_n_p" id="date_n_p" placeholder="Birth date" min="1900-01-01" max="2005-12-31" required />
         <input type="number" name="tel_p" id="tel_p" placeholder="Phone number"  required />
